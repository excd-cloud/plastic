export const state = () => ({
  shops: [
    ...
    },
    {
      ...
      description:
        "パスタやドライフルーツ、ナッツなど、イタリア・フランスを中心としたオーガニックの輸入食材を量り売りしている。",
      prefecture: "東京",
      location: "六本木・麻布・広尾",
    ...
    },
    {
      ...
      description:
        "食べ物から日用品まで量り売りで購入できるお店。はちみつやナッツ、シャンプーや洗剤が買える。",
      prefecture: "神奈川県",
      location: "多摩川・武蔵小杉",
    ...
    },
    {
      ...
      description:
        "常時18種類のビールを用意しているクラフトビールショップ。店頭で購入できるリユースボトルにクラフトビールを注いでもらえる。二度目以降は、リユースボトルの購入は不要。",
      prefecture: "東京",
      location: "渋谷・代々木・下北沢",
      hours: "3pm-12am",
      station: "下北沢駅",
